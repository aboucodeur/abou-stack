  ...
  document
    ...
    .addEventListener("show.bs.modal", function (e) {
      (count = contactList.items.length + 1),
        "edit" === action
          ? ((document.getElementById("contact-modal-label").innerHTML =
              "Edit Contact"),
        ...
        e.addEventListener("click", function (e) {
          e.target.closest("tr").children[1].innerText,
            ...
            t.get({ id: rowId }).forEach(function (e) {
              (currentRow = JSON.parse(JSON.stringify(e._values))).id ==
                rowId &&
                ((document.getElementById("view-detail-name").innerHTML =
                  currentRow.name),
                (document.getElementById("view-detail-current-job").innerHTML =
                  currentRow.designation + " at " + currentRow.company_name),
                (document.getElementById("view-detail-email-id").innerHTML =
                  currentRow.email_id),
                (document.getElementById("view-detail-phone").innerHTML =
                  currentRow.phone),
                (document.getElementById("view-detail-last-contact").innerHTML =
                  currentRow.last_contact),
                (document.getElementById("view-detail-lead-status").innerHTML =
                  currentRow.lead_status),
                (document.getElementById("view-detail-designation").innerHTML =
                  currentRow.designation),
                (document.getElementById("view-detail-image").src =
                  currentRow.avatar_img),
